...
<head>
  ...
  <title>Products Details | Lee's VHS Movies Ordering System</title>
  <!-- Bootstrap -->
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-xs-12 col-sm-5 col-sm-offset-1 col-md-4 col-md-offset-2 well well-sm text-center">
        ...
        ?>
        <img src="products/<?php echo $readrow['fld_product_image'] ?>" class="img-responsive" style="max-width:80%; max-height:80%;">
        <?php 
          } 
        ?>
        </div>
        <div class="col-xs-12 col-sm-5 col-md-4">
          <div class="panel panel-default">
            <div class="panel-heading"><strong>Product Details</strong></div>
              <div class="panel-body">Below are specifications of the product.
              </div>
            <table class="table">
              <tr>
              ...
              <tr>
                <td><strong>Country Released</strong></td>  
