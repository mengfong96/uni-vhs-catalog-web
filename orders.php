...
<head>
  ...
  <title>Orders | Lee's VHS Movies Ordering System</title>
  <!-- Bootstrap -->
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
        ...
        <form action="orders.php" method="post" class="form-horizontal">
          ...
          <div class="form-group">
            <label for="customerid" class="col-sm-3 control-label">Order Date</label>
            <div class="col-sm-9">
              <input name="orderdate" type="text" class="form-control" readonly value="<?php if(isset($_GET['edit'])) echo $editrow['fld_order_date']; ?>">
            </div>
          </div>
          <div class="form-group">
            <label for="customerid" class="col-sm-3 control-label">Staff</label>
            <div class="col-sm-9">
      ...
      <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
        ...
        <?php
          try {
            $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            $sql = "SELECT * FROM tbl_orders_a161103, tbl_staffs_a161103_pt2, tbl_customers_a161103_pt2 WHERE ";
            $sql = $sql."tbl_orders_a161103.fld_staff_num = tbl_staffs_a161103_pt2.fld_staff_num and ";
            $sql = $sql."tbl_orders_a161103.fld_customer_num = tbl_customers_a161103_pt2.fld_customer_num";
