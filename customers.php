...
<head>
  ...
  <title>Customer | Lee's VHS Movies Ordering System</title>
  <!-- Bootstrap -->
    ...
    <div class="row">
      ...
      <form action="customers.php" method="post" class="form-horizontal">
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <input name="cid" type="text" required class="form-control" placeholder="Customer ID" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_num']; ?>">
          </div>
        </div>
        <div class="form-group">
          <label for="fname" class="col-sm-3 control-label">First Name</label>
          <div class="col-sm-9">
            <input name="fname" type="text" required class="form-control" placeholder="First Name" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_fname']; ?>">
          </div>
        </div>
        <div class="form-group">
          <label for="lname" class="col-sm-3 control-label">Last Name</label>
          <div class="col-sm-9">
            <input name="lname" type="text" required class="form-control" placeholder="Last Name" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_lname']; ?>">
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <div class="radio">
              <label>
                <input id="gender" name="gender" type="radio" value="Male" <?php if(isset($_GET['edit'])) if($editrow['fld_customer_gender']=="Male") echo "checked"; ?>> Male
              </label>
            </div>
            <div class="radio">
              <label>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <input name="phone" type="text" pattern="^(\+?6?01)[0-46-9]-*[0-9]{7,8}$" required class="form-control" placeholder="Phone Number" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_phone']; ?>" <br>
          </div>
        </div>   
        <div class="form-group">
        ...
        <?php
          ...
          try {
            ...
            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
              $stmt = $conn->prepare("SELECT * FROM tbl_customers_a161103_pt2");
            $stmt->execute();
